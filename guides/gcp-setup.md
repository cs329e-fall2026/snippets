This guide walks you through setting up a shared GCP project for our *Elements of Data Visualization* class. Only one person per group needs to complete the setup.
...
9. In the **New Members** input box, enter scohen@utexas.edu and either diaindira@gmail.com or taliac@utexas.edu, depending on your section. Under **Role**, select the **Project Owner** role and save.
...
11. Retrieve your GCP coupon from the [Student Coupon Retrieval Link](https://gcp.secure.force.com/GCPEDU?cid=60gTaYjsk4Dzb4I2v4HwX8rHxmOKcWc%2BJBO%2B8N83OvYwRLPC7h6JLQnb2DY5Svzm/).  
